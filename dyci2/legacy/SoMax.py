...
if __name__ == '__main__':
    ...
    modelNavigator._simply_guided_navigation('c', time=1.0, update=True)
    modelNavigator._simply_guided_navigation('b', time=2.0, update=True)
    modelNavigator._simply_guided_navigation('a', time=3.0, update=True)
    ...
    print(event)
    modelNavigator._simply_guided_navigation('a', time=4.0, update=True)
