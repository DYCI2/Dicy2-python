...
if __name__ == '__main__':
    ...
    generation_handler: GenerationHandlerNew = GenerationHandlerNew(sequence=sequence, labels=labels, label_type=ChordLabel,
                                                                    model_navigator="FactorOracleNavigator",
                                                                    authorized_tranformations=authorized_intervals)
    generation_handler.memory.navigator.avoid_repetitions_mode = 1
    generation_handler.memory.navigator.max_continuity = 3
    generation_handler.memory.navigator.no_empty_event = False
